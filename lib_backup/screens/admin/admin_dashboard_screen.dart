...
class _AdminDashboardScreenState extends State<AdminDashboardScreen> {
  ...
  final List<SidebarMenuItem> _menuItems = const [
    ...
    SidebarMenuItem(
        title: 'Users', icon: Icons.people_outline, route: '/admin/users'),
    SidebarMenuItem(
        title: 'Restaurants',
            ...
            children: [
              Container(
                ...
                child: const Icon(Icons.person,
                    size: 25, color: AppTheme.mutedText),
              ),
              const SizedBox(width: 12),
              Expanded(
                child: Column(
                    ...
                    Row(
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color:
                                _getStatusColor(restaurant['status'] as String),
