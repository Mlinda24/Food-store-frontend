...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final List<Map<String, dynamic>> _featuredMeals = [
    ...
    },
    {
      ...
      'description': 'Traditional Malawian dish with beef, vegetables, and nsima',
      'price': 'MK8,000',
      'rating': 4.5,
      'reviews': 256,
      'prepTime': '20-25 min',
    ...
    },
    {
      ...
      'description': 'Grilled chicken breast with spicy sauce, lettuce, and cheese',
      'price': 'MK5,500',
      'rating': 4.3,
      'reviews': 89,
      'prepTime': '15-20 min',
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
            ...
            Padding(
              ...
              child: Container(
                ...
                child: TextField(
                  ...
                  style: TextStyle(color: isDark ? AppTheme.darkPrimaryText : AppTheme.lightPrimaryText, fontSize: 14),
                  onSubmitted: _onSearchSubmitted,
                  decoration: InputDecoration(
                    hintText: 'Search for sushi, pizza...',
                    hintStyle: TextStyle(color: isDark ? AppTheme.darkMutedText : AppTheme.lightMutedText, fontSize: 13),
                    prefixIcon: Icon(Icons.search, color: isDark ? AppTheme.darkMutedText : AppTheme.lightMutedText, size: 20),
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          TextButton(
                            onPressed: () {},
                            child: Text('See All', style: TextStyle(color: AppTheme.primaryRed, fontSize: 13)),
                          ),
                        ],
                      ),
                    ),
                    ...
                    SizedBox(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) => GestureDetector(
                          onTap: () => context.push('/food-detail', extra: _featuredMeals[index]),
                          child: FeaturedMealCard(meal: _featuredMeals[index], onTap: () {}),
                        ),
                      ),
                    ),
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        unselectedItemColor: isDark ? AppTheme.darkMutedText : AppTheme.lightMutedText,
        elevation: 8,
        items: const [
