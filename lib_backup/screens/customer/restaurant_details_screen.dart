...
class _RestaurantDetailsScreenState extends State<RestaurantDetailsScreen> {
  ...
  void _addToCart(BuildContext context, Map<String, dynamic> item, String restaurantId, String restaurantName) {
  ...
  void _updateQuantity(BuildContext context, String itemId, int newQuantity) {
    final cartProvider = Provider.of<CartProvider>(context, listen: false);
    if (newQuantity <= 0) {
  ...
  int _getQuantity(BuildContext context, String itemId) {
    final cartProvider = Provider.of<CartProvider>(context, listen: false);
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: hasItems ? AppTheme.primaryButtonGradient : const LinearGradient(colors: [Color(0xFFFFFFFF), Color(0xFFF5F5F5)], begin: Alignment.topLeft, end: Alignment.bottomRight),
  ...
  Widget _buildMenuItem(BuildContext context, Map<String, dynamic> item, String restaurantId, String restaurantName) {
    final quantity = _getQuantity(context, item['id']);
          ...
          Container(
            ...
            child: Row(
              children: [
                if (quantity > 0)
                  IconButton(
                    onPressed: () => _updateQuantity(context, item['id'], quantity - 1),
                ...
                if (quantity > 0)
                  Padding(
                    ...
                    child: Text('$quantity', style: const TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: AppTheme.primaryText)),
                  ),
                IconButton(
                  onPressed: () => _addToCart(context, item, restaurantId, restaurantName),
